    ...
    <div>
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center flex-col gap-3 justify-center text-center text-white">
          <h1 className="text-6xl font-bold cinzel-decorative-bold">Welcome</h1>
          <p className="mt-2 text-lg font-light">You can never get a cup of tea large enough or a book long enough to suit me.</p>
          <div className="max-w-lg mx-auto flex flex-col justify-center items-center gap-4 sm:flex-row md:mt-8 lg:mt-10">
            ...
            <a className="group relative inline-flex border border-red-600 focus:outline-none w-full sm:w-auto" href="" target="_blank">
      ...
      <div className="px-4 mt-4">
        <div className="flex flex-wrap gap-x-4 gap-y-8 justify-center items-center ">
          {books.map((book) => (
            <div key={book.id} className="border p-4 flex flex-col space-y-4 bg-white shadow-md rounded w-[250px]">
              <img
                src={book.coverImage}
                alt={book.title}
